    ...
    <div style={passedStyles} className={styles.card}>
      <div className={styles.cardTitle}>
        ...
        <button
          ...
          onClick={editable ? modifyContext : () => updateEditable(true)}
        >
          {editable ? (
            <svg
            ...
            >
              <path
                d="m401.648438 18.234375c-24.394532-24.351563-63.898438-24.351563-88.292969 0l-22.101563 
      ...
      {editable ? (
        <div className={styles.spaceBetween}>
          ...
          <input
            type="date"
            onChange={(e) => {
              updateDueDate(dateObjToTimestamp(e.target.value));
            }}
          ></input>
        </div>
      ) : newContext[props.listIndex][props.index].dueDate ? (
